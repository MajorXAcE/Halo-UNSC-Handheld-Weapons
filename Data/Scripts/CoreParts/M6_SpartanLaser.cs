...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition M6_SpartanLaser => new WeaponDefinition
        {
            ...
            {
                PartName = "M6 Spartan Laser", // name of weapon in terminal
                DeviateShotAngle = 0f,
                ...
                Loading = new LoadingDef
                {
                    ...
                    SkipBarrels = 0,
                    ReloadTime = 180, //10800 // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    DelayUntilFire = 160, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                {
                    PreFiringSound = "M6_SpartanLaser_Charge",
                    FiringSound = "M6_SpartanLaser_Fire", // WepShipGatlingShot
