        ...
        private AmmoDef M6_SpartanLaser_Ammo => new AmmoDef
        {
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                Base = new AreaInfluence
                {
                    ...
                    EffectStrength = 50f, // For ewar it applies this amount per pulse/hit, non-ewar applies this as damage per tick per entity in area of influence. For radiant 0 == use spillover from BaseDamage, otherwise use this value.
                },
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 2.5f,
                        Width = 0.025f,
                        Color = Color(red: 30f, green: 5f, blue: 3f, alpha: 1f),
            ...
            {
                TravelSound = "",
                HitSound = "M6_SpartanLaser_Impact",
                ShieldHitSound = "",
                PlayerHitSound = "",
                VoxelHitSound = "",
                FloatingHitSound = "",
